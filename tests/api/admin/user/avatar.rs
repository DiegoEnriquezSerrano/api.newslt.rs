...
#[tokio::test]
async fn authenticated_user_can_update_profile_avatar() {
    ...
    let response = app
        .put_admin_update_user_profile_avatar(&serde_json::json!({
    ...
    assert!(response_body.avatar_url.contains(&format!(
        "/images/user/avatar/{}.webp",
